     ...
     /*   public string Serialize()
        {
            ...
            foreach (PropertyInfo property in this.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public))
            {
                ...
                else if (property.Name == "ConnectedInputCounterMatrix")
                {
                    sb.AppendLine();
                    sb.Append("<?");
                    ...
                    sb.Append(property.Name);
                    sb.Append(": ");
                    sb.Append(this.ConnectedInputCounterMatrix.Serialize());
                }

                else if (property.Name == "ProximalDendrite")
                {
                    sb.AppendLine();
                    sb.Append("<?");
                    ...
                    sb.Append(property.Name);
                    sb.Append(": ");
                    sb.Append(this.ProximalDendrite.Serialize());
                }
            ...
            {
                if (field.Name == "connectedInputCounter")
                {
                    sb.AppendLine();
                    sb.Append("<?");
                    ...
                    sb.Append(": ");
                    sb.Append(this.connectedInputCounter.Serialize());
                }
                else
                {
                    sb.AppendLine();
