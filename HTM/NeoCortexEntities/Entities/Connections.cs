    ...
    /*    public string Serialize()
        {
            ...
            foreach (PropertyInfo property in this.GetType().GetProperties(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public))
            {
                ...
                else if (property.Name == "ColumnTopology")
                {
                    sb.Append(this.ColumnTopology.Serialize());
                }
                else if (property.Name == "HtmConfig")
                {
                    sb.Append(this.HtmConfig.Serialize());
                }
                else if (property.Name == "lastActivity")
                {
                    sb.Append(this.lastActivity.Serialize());
                }
                else if (property.Name == "cells")
                {

                    foreach (var cell in this.cells)
                    {
                        //  if (cell != null)
                        sb.Append(cell.Serialize());
                    }
            ...
            foreach (FieldInfo field in this.GetType().GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static))
            {
                ...
                else if (field.Name == "inputMatrix")
                {


                    sb.Append(field.Name);
                    sb.Append(inputMatrix.Serialize(this.inputMatrix));
                }


                else if (field.Name == "InputTopology")
                {
                    sb.AppendLine();
                    sb.Append("<?");
                ...
                else if (field.Name == "ColumnTopology")
                {
                    sb.AppendLine();
                    sb.Append("<?");
                ...
                else if (field.Name == "connectedCounts2")
                {
                    if (this.connectedCounts2 != null)
                    {
                        ...
                        sb.Append(field.Name);
                        sb.Append(": ");
                        sb.Append(this.connectedCounts2.Serialize());
                    }
                    else
                    {
                        sb.AppendLine();
                ...
                else if (field.Name == "memory")
                {
                    ...
                    sb.Append(field.Name);
                    sb.Append(": ");
                    sb.Append(this.memory.Serialize(this.memory));
                }
                else if (field.Name == "m_HtmConfig")
                {
                    sb.AppendLine();
                    sb.Append("<?");
                    ...
                    sb.Append(field.Name);
                    sb.Append(": ");
                    sb.Append(this.m_HtmConfig.Serialize());
                }

                else if (field.Name == "lastActivity")
                {
